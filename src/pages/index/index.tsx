...
export default class Index extends Component {
  ...
  render() {
    ...
    return (
      <View
        className="container"
        onClick={this.onResetItemsSlideStatus.bind(this)}
      >
        <ScrollView>
          {lists.map(item => {
            return (
              <MovableArea className="movablearea" key={item.key}>
                <MovableView
                  className="movableview"
                  damping={50}
                  friction={20}
                  onHTouchMove={this.onHTouchMoveHandler.bind(this)}
                ...
                >
                  <View
                    ...
                    onTouchEnd={this.onHandleSlideOut.bind(this)}
                    onClick={this.navigateToNextPage.bind(this)}
                  >
                    我是列表第{item.key}项
                  </View>
                  <View
